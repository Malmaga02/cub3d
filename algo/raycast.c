...
/*   Updated: 2024/11/19 21:13:39 by brulutaj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	pAll->algo.hit_point = (t_point){.x = pAll->player.pos.x + (pAll->algo.perp_wall_dist * pAll->algo.ray_dir_x),
	.y = pAll->player.pos.y + pAll->algo.perp_wall_dist * pAll->algo.ray_dir_y};
}
